...
And it's paired with a set of [Claude skills](./appendices/claude-skills-guide.md) that turn the book into a drill loop: daily challenges, combo drills, in-game tactical lookups, and post-game tracking. The book is inert reference until you use it. The skills make you use it.
...
Every chapter carries a `Last revised: YYYY-MM-DD` footer. See the [Meta Changelog](./appendices/changelog-of-meta.md) for the running log.

## How to read next

- **New to serious play?** Start with [How to Use This Book](./how-to-use.md), then [The Core Loop](./foundations/core-loop.md).
- **Skilled solo player, going multiplayer?** Skip to [Part VII — Playing with Others](./social/index.md).
- **Looking up a spirit tonight?** Hit the [Spirit Index](./spirits/index.md) and the Rei-format chapter for that spirit.
- **Mid-game, need a tactical answer?** Use the [Claude Skills Companion](./appendices/claude-skills-guide.md)'s `si-at-the-table` skill.
