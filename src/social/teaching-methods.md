...
4. Never say "you should have played X on T3." See [Post-Game Debrief](./post-game-debrief.md).

## Cross-references

- [Teaching Anti-Patterns](./teaching-anti-patterns.md) — explicit list of don'ts.
- [Alpha-Player Problem](./alpha-player-problem.md) — the mid-game failure mode teachers fall into.
- [Post-Game Debrief](./post-game-debrief.md) — how to debrief without tilting the learner.
- [Mixed-Skill Tables](./mixed-skill-tables.md) — when teaching scales up.
