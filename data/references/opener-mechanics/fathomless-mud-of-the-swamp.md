...
- **SPREADING AND DREADFUL MIRE** (Speed: Slow · Range: 1 · Target: invaders)
  - **L1** — 1 Water: Move 1 Presence from the origin Sacred Site to target land. (This is required.)
  - **L2** — 1 Moon + 2 Water + 1 Earth: 1 Fear. 1 Damage. Push 1 Dahan.
  - **L3** — 2 Moon + 3 Water + 2 Earth: 1 Fear. 1 Damage. Push 1 Dahan.
  - **L4** — 3 Moon + 4 Water + 3 Earth + 2 Plant: 2 Damage.
